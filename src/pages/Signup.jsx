...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(`Account created! Welcome, ${displayName}`, { icon: "✨" });
            navigate("/");
        } catch (error) {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            toast.success("Welcome to OmniMart!", { icon: "🚀" });
            navigate("/");
        } catch (error) {
            toast.error(error.message);
        } finally {
            ...
            <div className="max-w-md w-full">
                <div className="bg-white p-6 md:p-10 rounded-[32px] md:rounded-[40px] shadow-2xl border border-slate-100 relative overflow-hidden">
                    ...
                    <div className="text-center mb-8 md:mb-10">
                        <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-2">Join OmniMart</h2>
                        <p className="text-sm md:text-base text-slate-500 font-medium">Create your account to start shopping</p>
                    </div>
                    ...
                    <div className="mt-10 pt-8 border-t border-slate-100 text-center">
                        <p className="text-slate-500 font-medium">
                            ...
                            <Link to="/login" className="text-primary font-black hover:underline underline-offset-4">Log In</Link>
                        </p>
                    </div>
                </div>
            </div>
